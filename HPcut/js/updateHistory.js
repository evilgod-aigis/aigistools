const updateHistory = [
    ...
    */
        date: "2026/03/26(木)"
        , detail: [
            "初動短縮オプションに「王国演習場」を追加"
        ]
    }
    , {
        date: "2026/02/26(木)"
        , detail: [
            "硬直短縮オプションに「大海の歌声ルクシエ」を追加"
            , "鈍化(マップ)の軽減オプションに「大海の歌声ルクシエ」を追加"
        ]
    }
    , {
        date: "2026/02/19(木)"
    ...
    */
    ...
    , {
        ...
        , detail: [
            "「幽幻仮装ニコル」を追加"
            , "ユニット追加に「スキル終了時に撤退またはHP0→再出撃」の設定項目を追加"
        ]
    }
    , {
        date: "2025/09/30(火)"
        , detail: [
            "硬直短縮(固定値化)オプションに「九尾娘の異装しづり」を追加"
            , "被ダメ増加オプションに「冥府館の異装テュト」を追加"
        ]
    }
    , {
        date: "2025/09/25(木)"
        , detail: [
            "「荀彧 文若」を追加"
            , "硬直短縮オプションに「琵琶法師ヤサカ」を追加"
        ]
    }
    , {
        date: "2025/09/11(木)"
        , detail: [
            //"硬直短縮オプションに「夏侯淵 妙才」を追加"
            "被ダメ増加オプションに「夏侯淵 妙才」を追加"
            , "フロー削除後、ページ再読み込み等すると表示がおかしくなる不具合を修正"
        ]
    }
    , {
    /*
        date: "2025/08/28(木)"
        , detail: [
            "硬直短縮オプションに「華の四神 白虎」「火蜥蜴の召喚士リノ」を追加"
        ]
    }
    , {
        date: "2025/08/05(火)"
        , detail: [
            "硬直短縮オプションに「円卓城の異装ティルト」「統帥の杖」を追加"
        ]
    }
    , {
    */
        date: "2025/07/31(木)"
        , detail: [
            "鈍化(マップ)の軽減オプションに「蒼の海巫女ピュレスカ」を追加"
        ]
    }
    , {
        date: "2025/06/12(木)"
        , detail: [
            "被ダメ増加オプションに「嫁入り天狗ホムラ」を追加"
        ]
    }
    , {
        date: "2025/05/29(木)"
    ...
    , {
        date: "2025/02/20(木)"
        , detail: [
            "硬直短縮オプションに「歴戦弓兵ダニエラ」を追加"
        ]
    }
    , {
        date: "2025/02/06(水)"
        , detail: [
            "被ダメ増加オプションに「乙女の守護者アデライド」を追加"
        ]
    }
    , {
        date: "2025/01/01(水)"
    ...
    , {
        ...
        , detail: [
            "「恋の親衛隊シャディア」を追加"
            , "ユニット追加に「敵の残りHPによる攻撃増加」の設定項目を追加"
            , "グラフのレイアウトをほんの少し修正"
        ]
    }
    , {
