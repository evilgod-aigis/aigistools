const updateHistory = [
    ...
    */
    ...
    , {
        date: "2026/05/21(木)"
        , detail: [
            "ドミナ、マサムネ、ファルタリアのトークンを追加"
        ]
    }
    , {
        date: "2026/04/30(木)"
        , detail: [
            "王子【双鴉】、ガルヴェイン[黒][白]を追加"
            , "バランス調整を反映"
        ]
    }
    , {
        date: "2026/04/13(月)"
        , detail: [
            "コメット、アナトリア/学園、エスネア/エッグハント、メローネ/エッグハントを追加"
        ]
    }
    , {
        date: "2026/04/02(木)"
    ...
    , {
        date: "2026/01/01(木)"
        , detail: [
            "ヒミコ/お正月、へカティエ/お正月、ルキファ/お正月[白]、ちびデステリカを追加"
        ]
    }
    , {
        date: "2025/12/29(月)"
    ...
    , {
        date: "2025/10/14(火)"
        , detail: [
            "スウィーティア、ニコル/ハロウィン、ミリアム/ハロウィンを追加"
        ]
    }
    , {
        date: "2025/10/01(水)"
    ...
    , {
        date: "2025/09/30(火)"
        , detail: [
            "蠅王娘【モンスター娘TD】系クラス、テュト/異装、しづり/異装を追加"
        ]
    }
    , {
        date: "2025/09/25(木)"
    ...
    , {
        date: "2025/06/26(木)"
        , detail: [
            "スーシェン/水着、乙姫/水着、イコル/水着、ニミュエ/花嫁のトークン、クロノシア/水着のトークンを追加"
        ]
    }
    , {
        date: "2025/06/12(木)"
