...
debuff.hit = [
    ...
    , {
        name: "ランシェ", rarity: "白", cl: "マギステルミリトゥム", AW: "覚醒", skill: "覚醒"
        , stats: { atk: "-20%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "ディーナ", rarity: "黒", cl: "ヘビーアーマー", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-30%" }
        , atkAttr: "物理", dur: "59f"
    }
    , {
        name: "ラビリス", rarity: "黒", cl: "ヘビーアーマー", AW: "未", skill: "通常"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "ラビリス", rarity: "黒", cl: "ヘビーアーマー", AW: "覚醒", skill: "通常"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "エルデ", rarity: "白", cl: "ヘビーアーマー", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-30%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "ウィリアス/ハロウィン", rarity: "白", cl: "中級竜兵", AW: "覚醒", skill: "通常"
        , stats: { def: "-30%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "チヨメ", rarity: "黒", cl: "忍者", AW: "未", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "9f"
    }
    , {
    ...
    , {
        name: "マツリ/お正月", rarity: "黒", cl: "前衛戦術家", AW: "未"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "7f"
    }
    , {
    ...
    , {
        name: "エメルダ/バレンタイン", rarity: "黒", cl: "ボウライダー", AW: "未", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "7f"
    }
    , {
        name: "エメルダ/バレンタイン", rarity: "黒", cl: "ボウライダー", AW: "覚醒", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "7f"
    }
    , {
    ...
    , {
        name: "ラクシャーサ", rarity: "黒", cl: "魔神", AW: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "119f"
        , note: "死亡時"
    }
    , {
        name: "ラクシャーサ", rarity: "黒", cl: "魔神", AW: "覚醒", skill: [ "通常", "覚醒" ]
        , stats: { stop: "○" }
        , atkAttr: "貫通", dur: "119f"
        , note: "死亡時"
    }
    ...
    , {
        name: "スーシェン", rarity: "黒", cl: "キョンシー", AW: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "貫通", dur: "359f"
        , note: "死亡時"
    }
    ...
    , {
        name: "ランヒルド/バニー", rarity: "黒", cl: "モンスターブレイカー", AW: "覚醒", skill: "通常"
        , stats: { atk: "-30%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "聞忠", rarity: "黒", cl: "邪仙", AW: "未", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "?f"
        , note: "確率40%で貫通"
    }
    , {
        name: "聞忠", rarity: "黒", cl: "邪仙", AW: "覚醒", skill: [ "通常", "覚醒" ]
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "14f"
        , note: "通常スキルは確率40%で貫通"
    }
    ...
    , {
        name: "アビスリベリオン", cl: "魔王親衛隊", AW: "覚1"
        , stats: { atk: "-30%" }
        , atkAttr: "物理", dur: "59f"
        , note: "魔王親衛隊系"
    }
    , {
        name: "アビスセンチネル", cl: "魔王親衛隊", AW: "覚2a"
        , stats: { atk: "-40%" }
        , atkAttr: "物理", dur: "59f"
        , note: "魔王親衛隊系"
    }
    , {
        name: "アビスレイダー", cl: "魔王親衛隊", AW: "覚2b"
        , stats: { atk: "-30%" }
        , atkAttr: "物理", dur: "59f"
        , note: "魔王親衛隊系"
    }
    , {
        name: "タチバナ", rarity: "黒", cl: "鬼刃忍", AW: "覚醒", skill: [ "通常", "覚醒" ]
        , stats: { atk: "-15%" }
        , atkAttr: "物理", dur: "29f"
    }
    , {
        name: "ヤハール/花嫁", rarity: "白", cl: "デーモンロード", AW: "未", skill: "通常"
        , stats: { atk: "-15%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "ヤハール/花嫁", rarity: "白", cl: "デーモンロード", AW: "覚醒", skill: "通常"
        , stats: { atk: "-15%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "犬神", cl: "犬神", AW: "未", skill: "通常"
        , stats: { atkCd: "+30f" }
        , atkAttr: "?", dur: "119f"
    }
    , {
    ...
    , {
        name: "ツムジ", rarity: "白", cl: "犬神", AW: "未", skill: "通常"
        , stats: { atk: "-10%" }
        , atkAttr: "貫通", dur: "44f"
    }
    , {
        name: "ツムジ", rarity: "白", cl: "犬神", AW: "覚醒", skill: "通常"
        , stats: { atk: "-10%" }
        , atkAttr: "貫通", dur: "44f"
    }
    , {
        name: "ツムジ", rarity: "白", cl: "犬神", AW: "覚醒", skill: "覚醒"
        , stats: { atk: "-30%" }
        , atkAttr: "貫通", dur: "44f"
    }
    , {
    ...
    , {
        name: "エフネ", rarity: "白", cl: "デモンルーン", AW: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "149f"
        , note: "死亡時"
    }
    , {
        name: "エフネ", rarity: "白", cl: "デモンルーン", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "貫通", dur: "149f"
        , note: "死亡時"
    }
    ...
    , {
        name: "ハリナ", rarity: "黒", cl: "エンプレス", AW: "未", skill: "非"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "7f"
        , note: "非ブロック時"
    }
    , {
        name: "ハリナ", rarity: "黒", cl: "エンプレス", AW: "覚醒", skill: "非"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "7f"
        , note: "非ブロック時"
    }
    ...
    , {
        name: "カウリオ", rarity: "白", cl: "シーソルジャー", AW: "未", skill: "通常"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "カウリオ", rarity: "白", cl: "シーソルジャー", AW: "覚醒", skill: "通常"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "フーイェン", rarity: "白", cl: "武侠", AW: "覚醒", skill: "通常"
        , stats: { def: "-40%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "ミュレ", rarity: "黒", cl: "隧道掘削兵", AW: "未", skill: "通常"
        , stats: { def: "*1.5" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "ミュレ", rarity: "黒", cl: "隧道掘削兵", AW: "覚醒", skill: "通常"
        , stats: { def: "*1.5" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "ヘーレ", rarity: "白", cl: "隧道掘削兵", AW: "未", skill: "通常"
        , stats: { atk: "-30%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "ヘーレ", rarity: "白", cl: "隧道掘削兵", AW: "覚醒", skill: "通常"
        , stats: { atk: "-30%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "ヘーレ", rarity: "白", cl: "隧道掘削兵", AW: "覚醒", skill: "覚醒"
        , stats: { atk: "-50%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "サティン", rarity: "白", cl: "処刑人", AW: "未"
        , stats: { def: "-15%" }
        , atkAttr: "物理", dur: "∞"
        , note: "分類未確認"
    }
    , {
        name: "サティン", rarity: "白", cl: "処刑人", AW: "覚醒"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "∞"
        , note: "分類未確認"
    }
    ...
    , {
        name: "リムリィ/水着", rarity: "白", cl: "処刑人", AW: "覚醒", skill: "覚醒(2)"
        , stats: { def: "-50%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "リムリィ/水着", rarity: "白", cl: "処刑人", AW: "覚醒", skill: "覚醒(3～)"
        , stats: { def: "-70%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "ユリクセス", rarity: "黒", cl: "神話の継承者", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-40%" }
        , atkAttr: "物理", dur: "59f"
    }
    , {
    ...
    , {
        name: "ララネ", rarity: "黒", cl: "妖糸使い", AW: "未", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "29f"
    }
    , {
        name: "ララネ", rarity: "黒", cl: "妖糸使い", AW: "覚醒", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "29f"
    }
    , {
        name: "クローシェ", rarity: "白", cl: "妖糸使い", AW: "未"
        , stats: { def: "-10%" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "クローシェ", rarity: "白", cl: "妖糸使い", AW: "覚醒"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
    ...
    , {
        name: "ユーティ/花嫁", rarity: "白", cl: "ウィッチ", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "19f"
    }
    , {
    ...
    , {
        name: "クルス", rarity: "黒", cl: "ヴァンパイアハンター", AW: "覚醒", skill: "通常"
        , stats: { atk: "-30%" }
        , atkAttr: "貫通", dur: "?f"
        , target: { attr: [ "アンデッド" ] }
    }
    ...
    , {
        name: "ハイデマリー", rarity: "白", cl: "砲術士", AW: "未", skill: "通常"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "ハイデマリー", rarity: "白", cl: "砲術士", AW: "覚醒", skill: "通常"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "ハイデマリー", rarity: "白", cl: "砲術士", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-20%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "メル/浴衣", rarity: "白", cl: "砲術士", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "10f"
    }
    , {
    ...
    , {
        name: "トワ/学園", rarity: "黒", cl: "クロノウィッチ", AW: "覚醒", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "19f"
    }
    , {
    ...
    , {
        name: "ニコル", rarity: "黒", cl: "アルケミスト", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "9f"
    }
    , {
    ...
    , {
        name: "ヒルデ", rarity: "白", cl: "モンスタースレイヤー", AW: "覚2a"
        , stats: { atk: "-20%" }
        , atkAttr: "貫通", dur: "89f"
    }
    , {
        name: "ドルチェ/水着", rarity: "白", cl: "モンスタースレイヤー", AW: "未", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "19f"
    }
    , {
    ...
    , {
        name: "ラトゥール", rarity: "白", cl: "道化師", AW: "未"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "4f"
        , note: "確率20%?で貫通"
    }
    , {
        name: "ラトゥール", rarity: "白", cl: "道化師", AW: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "4f"
        , note: "確率20%?で貫通"
    }
    , {
        name: "ラトゥール/浴衣", rarity: "白", cl: "道化師", AW: "未", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "149f"
        , note: "確率20%?で貫通"
    }
    , {
        name: "ラトゥール/浴衣", rarity: "白", cl: "道化師", AW: "覚醒", skill: "通常"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "149f"
        , note: "確率20%?で貫通"
    }
    , {
        name: "ラトゥール/浴衣", rarity: "白", cl: "道化師", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "貫通", dur: "4f"
        , note: "確率20%?で貫通"
    }
    ...
    , {
        name: "マルレーン", rarity: "黒", cl: "支援工兵", AW: "未", skill: "通常"
        , stats: { atkCd: "+30f" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "マルレーン", rarity: "黒", cl: "支援工兵", AW: "覚醒", skill: "通常"
        , stats: { atkCd: "+30f" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "パトリシア", rarity: "白", cl: "支援工兵", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "14f"
    }
    , {
    ...
    , {
        name: "マギー", rarity: "白", cl: "発明家", AW: "未", skill: "通常"
        , stats: { def: "-30%" }
        , atkAttr: "貫通", dur: "?f"
    }
    , {
    ...
    , {
        name: "メシナ/お正月", rarity: "黒", cl: "儀式魔術師", AW: "未"
        , stats: { atkCd: "+30f" }
        , atkAttr: "魔法", dur: "?f"
    }
    , {
        name: "メシナ/お正月", rarity: "黒", cl: "儀式魔術師", AW: "覚醒"
        , stats: { atkCd: "+30f" }
        , atkAttr: "魔法", dur: "?f"
    }
    , {
        name: "ドラグーン", cl: "ドラグーン", AW: "未"
        , stats: { def: "-30%" }
        , atkAttr: "物理", dur: "29f"
    }
    , {
        name: "ドラグーンチーフ", cl: "ドラグーン", AW: "覚1"
        , stats: { def: "-40%" }
        , atkAttr: "物理", dur: "29f"
        , note: "ドラグーン系"
    }
    , {
        name: "ドラグーンオードナンス", cl: "ドラグーン", AW: "覚2a"
        , stats: { def: "-50%" }
        , atkAttr: "物理", dur: "29f"
        , note: "ドラグーン系"
    }
    , {
        name: "竜砲騎士隊長", cl: "ドラグーン", AW: "覚2b"
        , stats: { def: "-40%" }
        , atkAttr: "物理", dur: "29f"
        , note: "ドラグーン系"
    }
    ...
    , {
        name: "デステリカ", rarity: "黒", cl: "ガンスリンガー", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-80%" }
        , atkAttr: "物理", dur: "14f"
    }
    , {
    ...
    , {
        name: "クレール/浴衣", rarity: "黒", cl: "ロケットトルーパー", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-50%", mr: "-50%" }
        , atkAttr: "物理", dur: "750f"
        , note: "分類未確認"
    }
    , {
        name: "オヴェリー", rarity: "白", cl: "ロケットトルーパー", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-50%" }
        , atkAttr: "物理", dur: "299f"
    }
    , {
    ...
    , {
        name: "フェリス", rarity: "黒", cl: "逃亡悪魔【ランス】", AW: "覚醒"
        , stats: { atk: "-20%", def: "-20%" }
        , atkAttr: "物理", dur: "59f"
    }
    , {
        name: [ "リズナ・", "ランフビット" ], rarity: "黒", cl: "旅人【ランス】", AW: "未", skill: "通常"
        , stats: { atk: "-20%", def: "-20%" }
        , atkAttr: "魔法", dur: "?f"
    }
    , {
        name: [ "リズナ・", "ランフビット" ], rarity: "黒", cl: "旅人【ランス】", AW: "覚醒", skill: "通常"
        , stats: { atk: "-20%", def: "-20%" }
        , atkAttr: "魔法", dur: "?f"
    }
    , {
    ...
    , {
        name: "黄蓋 公覆", rarity: "白", cl: "弓将【恋姫】", AW: "覚醒"
        , stats: { atk: "-15%" }
        , atkAttr: "魔法", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "戯曲作家【GBM】", cl: "戯曲作家【GBM】", AW: "未"
        , stats: { atk: "-7%", def: "-7%" }
        , atkAttr: "物理", dur: "59f"
    }
    , {
        name: "詩聖【GBM】", cl: "戯曲作家【GBM】", AW: "覚1"
        , stats: { atk: "-10%", def: "-10%" }
        , atkAttr: "物理", dur: "59f"
        , note: "戯曲作家【GBM】系"
    }
    ...
    , {
        name: "ファウスト", rarity: "黒", cl: "錬金術師【GBM】", AW: "覚醒", skill: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "物理", dur: "104f"
    }
    , {
        name: "四ノ宮小町", rarity: "黒", cl: "交通課職員【流星WA】", AW: "未", skill: "通常"
        , stats: { def: "-30%" }
        , atkAttr: "物理", dur: "44f"
    }
    , {
        name: "四ノ宮小町", rarity: "黒", cl: "交通課職員【流星WA】", AW: "覚醒", skill: "通常"
        , stats: { def: "-30%" }
        , atkAttr: "物理", dur: "44f"
    }
    , {
        name: "四ノ宮小町", rarity: "黒", cl: "交通課職員【流星WA】", AW: "覚醒", skill: "覚醒"
        , stats: { atk: "-30%" }
        , atkAttr: "物理", dur: "44f"
    }
    , {
        name: "葵", rarity: "黒", cl: "鬼【ななリン】", AW: "覚醒", skill: "覚醒"
        , stats: { def: "-50%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "アイリス", rarity: "白", cl: "鬼【ななリン】", AW: "覚醒", skill: "覚醒"
        , stats: { atk: "-40%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "心願寺紅", rarity: "白", cl: "対魔忍 魔性【対魔忍】", AW: "未", skill: "通常"
        , stats: { def: "-60%" }
        , atkAttr: "物理", dur: "?f"
    }
    , {
        name: "心願寺紅", rarity: "白", cl: "対魔忍 魔性【対魔忍】", AW: "覚醒", skill: "通常"
        , stats: { def: "-60%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        name: "甲河アスカ", rarity: "白", cl: "対魔忍 科学【対魔忍】", AW: "未", skill: "通常"
        , stats: { def: "-80%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "甲河アスカ", rarity: "白", cl: "対魔忍 科学【対魔忍】", AW: "覚醒", skill: "通常"
        , stats: { def: "-80%" }
        , atkAttr: "物理", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "水城ゆきかぜ", rarity: "黒", cl: "対魔忍 自然【対魔忍】", AW: "未", skill: "通常"
        , stats: { atk: "-20%" }
        , atkAttr: "魔法", dur: "?f"
        , note: "分類未確認"
    }
    , {
        name: "水城ゆきかぜ", rarity: "黒", cl: "対魔忍 自然【対魔忍】", AW: "覚醒", skill: "通常"
        , stats: { atk: "-20%" }
        , atkAttr: "魔法", dur: "?f"
        , note: "分類未確認"
    }
    ...
    , {
        ...
        , stats: { def: "-50%" }
        , atkAttr: "貫通", dur: "∞"
        , note: [ "トラップマスター", "(レンジャー系)" ]
    }
    , {
        name: "アイスエレメンタル", rarity: "トークン", AW: "未"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "?f"
        , note: [ "ユキヒメ", "ユキヒメ/学園" ]
    }
    , {
        name: "上級アイスエレメンタル", rarity: "トークン", AW: "覚醒"
        , stats: { stop: "○" }
        , atkAttr: "魔法", dur: "19f"
        , note: [ "ユキヒメ", "ユキヒメ/学園" ]
    }
