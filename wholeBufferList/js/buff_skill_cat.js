...
buff.skill_cat = [
    ...
    , {
        name: "ヘレナ", rarity: "白", cl: "前衛戦術家", AW: "覚醒前", skill: "通常(偶)"
        , stats: { atk: "×1.2" }
    }
    , {
        name: "ヘレナ", rarity: "白", cl: "前衛戦術家", AW: "覚醒後", skill: "通常(奇)"
        , stats: { def: "×1.2" }
    }
    , {
        name: "ヘレナ", rarity: "白", cl: "前衛戦術家", AW: "覚醒後", skill: "通常(偶)"
        , stats: { atk: "×1.2" }
    }
    , {
        name: "オーガスタ/バレンタイン", rarity: "黒", cl: "料理人", AW: "覚醒前", skill: "通常"
        , stats: { atk: "×1.3", def: "×1.3" }
    }
    , {
        name: "オーガスタ/バレンタイン", rarity: "黒", cl: "料理人", AW: "覚醒後", skill: "通常"
        , stats: { atk: "×1.3", def: "×1.3" }
    }
    , {
    ...
    , {
        name: "リノ/バレンタイン", rarity: "白", cl: "サモナー", AW: "覚醒前", skill: "通常"
        , stats: { atk: "×1.2" }
    }
    , {
        name: "リノ/バレンタイン", rarity: "白", cl: "サモナー", AW: "覚醒後", skill: "通常"
        , stats: { atk: "×1.2" }
    }
    , {
        name: "リノ/バレンタイン", rarity: "白", cl: "サモナー", AW: "覚醒後", skill: "覚醒"
        , stats: { atk: "×1.3" }
        , note: "範囲"
    }
    , {
