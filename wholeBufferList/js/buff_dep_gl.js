...
buff.dep_gl = [
    ...
    , {
        name: "王子【翼蛇】", cl: "王子"
        , stats: { atk: "+20%", def: "+20%", rege: [ "40/秒", "200/150f" ] }
    }
    , {
        name: "王子【功夫】", cl: "王子"
        , stats: { atk: "+30%" }
    ...
    , {
        name: "ちびソフィー", rarity: "ちび", cl: "エンジェル", skill: "非"
        , stats: { rege: [ "20/秒", "10/15f" ] }
    }
    , {
    ...
    , {
        name: "風水仙人", cl: "風水使い", AW: "覚2a"
        , stats: { other: "" }
        , note: [ "地形-70%", "悪天候-50%", "風水使い系" ]
    }
    , {
        name: "八門風水導士", cl: "風水使い", AW: "覚2b"
        , stats: { other: "" }
        , note: [ "地形-70%", "悪天候-50%", "風水使い系" ]
    }
    , {
    ...
    , {
        name: "ソウルレゾナンサー", cl: "ライフリンカー", AW: "覚2b"
        , stats: { rege: [ "50/秒", "25/15f" ] }
        , note: "ライフリンカー系"
    }
    , {
    ...
    , {
        name: "ホーリーアポストル", cl: "ルーンアコライト", AW: "覚2a"
        , stats: { rege: [ "60/秒", "30/15f" ] }
        , note: "ルーンアコライト系"
    }
    , {
    ...
    , {
        name: "ちびダークアンナ", rarity: "ちび", cl: "政務官【闇の軍勢】", skill: "非"
        , stats: { rege: [ "24/秒", "12/15f" ] }
    }
    , {
