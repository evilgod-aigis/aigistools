...
buff.unique = [
    ...
    , {
        name: "天宇寿女命トークン", rarity: "トークン", AW: "未"
        , stats: { atk: "×1.5", def: "×1.5" }
        , type: "spot_mul"
        , note: [ "天宇寿女命", "区分：乗算マス", "継続：60秒" ]
    }
    , {
        name: "天宇寿女命トークン", rarity: "トークン", AW: "覚醒"
        , stats: { atk: "×1.6", def: "×1.6" }
        , type: "spot_mul"
        , note: [ "天宇寿女命", "区分：乗算マス", "継続：60秒" ]
    }
    ...
    , {
        name: "試しの場", rarity: "金", cl: "試しの場"
        , stats: { hp: "×1.3", atk: "×1.3" }
        , type: "spot_over"
        , note: [ "区分：マス上書き(両→両)", "分類未確認" ]
    }
    , {
        name: "大闘技場", cl: "大闘技場"
        , stats: { hp: "×1.3", atk: "×1.3", poison: "-100%" }
        , type: "spot_over"
        , note: [ "区分：マス上書き(近→近)", "地形-100%", "分類未確認" ]
    }
    , {
    ...
    , {
        ...
        , stats: { rege: [ "150/秒", "?/?f" ] }
        , type: "limit"
        , note: [ "区分：時限", "配置時", "継続：45秒" ]
    }
    , {
        name: "デモンルーン", cl: "デモンルーン", AW: "未"
        , stats: { atk: "+10%" }
        , type: "limit"
        , note: [ "区分：時限", "死亡時", "継続：10秒" ]
    }
    , {
        name: "デモンハイルーン", cl: "デモンルーン", AW: "覚1"
        , stats: { atk: "+15%" }
        , type: "limit"
        , note: [ "区分：時限", "死亡時", "継続：10秒", "デモンルーン系" ]
    }
    , {
        name: "デモンインフェルノ", cl: "デモンルーン", AW: "覚2a"
        , stats: { atk: "+25%" }
        , type: "limit"
        , note: [ "区分：時限", "死亡時", "継続：15秒", "デモンルーン系" ]
    }
    , {
    ...
    , {
        ...
        , stats: { atk: "-2%", def: "-2%" }
        , type: "limit"
        , note: [ "区分：時限", "死亡時", "継続：永続", "分類未確認" ]
    }
    , {
        name: "憑魔託宣者", cl: "デモンシャーマン", AW: "覚2a"
        , stats: { mr: "+5" }
        , type: "limit"
        , note: [ "区分：時限", "死亡時", "継続：20秒", "デモンシャーマン系", "分類未確認" ]
    }
    , {
    ...
    , {
        ...
        , stats: { hp: "+8%", atk: "+8%", def: "+8%" }
        , type: "Lukifer"
        , note: [ "区分：ルキファ死亡時", "死亡時範囲", "継続：永続", "2回まで累加" ]
    }
    ...
    , {
        name: "リンネ/新装", rarity: "黒", cl: "輪廻の風水師", AW: "覚醒", skill: "通常"
        , stats: { other: "" }
        , type: "dmg-red"
    ...
    , {
        name: "冒険者パーティー", rarity: "金", cl: "冒険者パーティー", skill: "通常"
        , stats: { other: "" }
        , type: "dmg-red"
        , note: [ "区分：被ダメージ軽減", "物理魔法-30%(範囲)", "分類未確認" ]
    }
    , {
        name: "エリアス/新装", rarity: "黒", cl: "ヒーラー", AW: "未", skill: "通常"
        , stats: { other: "" }
        , type: "dmg-red"
        , note: [ "区分：被ダメージ軽減", "物理魔法-30%(範囲)", "永続スキル", "分類未確認" ]
    }
    , {
    ...
    */
    ...
    , {
        ...
        , stats: { other: "" }
        , type: "dmg-red"
        , note: [ "ココン", "区分：被ダメージ軽減", "物理-20%(範囲)", "分類未確認" ]
    }
    , {
    ...
    , {
        name: "十二天将", rarity: "トークン", AW: "未", skill: "通常(5n-2)"
        , stats: { other: "" }
        , type: "dmg-red"
        , note: [ "セイメイ", "区分：被ダメージ軽減", "属性不問-30%(範囲)", "分類未確認" ]
    }
    , {
        name: "十二天将", rarity: "トークン", AW: "覚醒", skill: "通常(5n-2)"
        , stats: { other: "" }
        , type: "dmg-red"
        , note: [ "セイメイ", "区分：被ダメージ軽減", "属性不問-30%(範囲)", "分類未確認" ]
    }
...
/*
    ...
    spot_mul limit Lukifer nekomata
