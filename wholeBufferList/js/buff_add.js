...
buff.add = [
    ...
    , {
        name: "レオラ/新装", rarity: "黒", cl: "前衛戦術家", AW: "覚醒", skill: "覚醒(1)"
        , stats: { atk: "10%" }
        , note: "範囲"
    }
    , {
        name: "レオラ/新装", rarity: "黒", cl: "前衛戦術家", AW: "覚醒", skill: "覚醒(2)"
        , stats: { atk: "15%" }
        , note: "範囲"
    }
    , {
        name: "レオラ/新装", rarity: "黒", cl: "前衛戦術家", AW: "覚醒", skill: "覚醒(3～)"
        , stats: { atk: "20%" }
        , note: [ "範囲", "永続" ]
    }
    , {
    ...
    , {
        name: "タツミ/クリスマス", rarity: "黒", cl: "戦巫女", AW: "覚醒", skill: "覚醒"
        , stats: { atk: "14%", def: "14%" }
        , note: "範囲"
    }
    , {
    ...
    , {
        name: "オリュンポス要塞宮殿", cl: "オリュンポス要塞宮殿", AW: "未"
        , stats: { atk: "10%", def: "10%" }
        , note: "範囲"
    }
    , {
        name: "オリュンポス大要塞", cl: "オリュンポス要塞宮殿", AW: "覚1"
        , stats: { atk: "15%", def: "15%" }
        , note: [ "範囲", "オリュンポス要塞宮殿系" ]
    }
    , {
    ...
    , {
        name: "コマ/温泉", rarity: "黒", cl: "狛犬", AW: "未"
        , stats: { def: "+250", mr: "+2" }
        , note: [ "ヒール対象", "継続：?秒" ]
    }
    , {
    ...
    , {
        name: "コマ/温泉", rarity: "黒", cl: "狛犬", AW: "覚醒"
        , stats: { def: "+350", mr: "+4" }
        , note: [ "ヒール対象", "継続：?秒" ]
    }
    , {
        name: "コマ/温泉", rarity: "黒", cl: "狛犬", AW: "覚醒", skill: "通常"
        , stats: { def: "+630", mr: "+4" }
        , note: [ "ヒール対象", "継続：?秒" ]
    }
    , {
        name: "コマ/温泉", rarity: "黒", cl: "狛犬", AW: "覚醒", skill: "覚醒(3～)"
        , stats: { def: "+525", mr: "+6" }
        , note: [ "ヒール対象", "継続：?秒", "永続スキル" ]
    }
    , {
    ...
    , {
        ...
        , stats: { atk: "+360", range: "+12" }
        , note: [ "ヒール対象(優先：攻撃力)", "継続：12.5秒", "永続スキル" ]
    }
    , {
        name: "キリエ/学園", rarity: "黒", cl: "メディック", AW: "未"
        , stats: { atk: "+150", range: "+10" }
        , note: [ "ヒール対象(優先：攻撃力)", "継続：12.5秒" ]
    }
    , {
        name: "キリエ/学園", rarity: "黒", cl: "メディック", AW: "未", skill: "通常"
        , stats: { atk: "+225", range: "+15" }
        , note: [ "ヒール対象(優先：攻撃力)", "継続：12.5秒" ]
    }
    , {
        name: "キリエ/学園", rarity: "黒", cl: "メディック", AW: "覚醒"
        , stats: { atk: "+200", range: "+15" }
        , note: [ "ヒール対象(優先：攻撃力)", "継続：12.5秒" ]
    }
    , {
        name: "キリエ/学園", rarity: "黒", cl: "メディック", AW: "覚醒", skill: "通常"
        , stats: { atk: "+300", range: "+22" }
        , note: [ "ヒール対象(優先：攻撃力)", "継続：12.5秒" ]
    }
    , {
    ...
    , {
        ...
        , stats: { def: "+375", mr: "+9", other: "" }
        , note: [ "ヒール対象(優先：防御力)", "継続：18.75秒" ]
    }
    , {
    ...
    , {
        name: "冬姫【白面金毛】", rarity: "黒", cl: "冬姫【白面金毛】", AW: "未"
        , stats: { atk: "+550", def: "+550" }
        , note: [ "範囲", "最大値(攻・防+4/秒)", "トークン含" ]
    }
    , {
        name: "冬将軍【白面金毛】", rarity: "黒", cl: "冬姫【白面金毛】", AW: "覚1"
        , stats: { atk: "+600", def: "+600" }
        , note: [ "範囲", "最大値(攻・防+5/秒)", "トークン含", "冬姫【白面金毛】系" ]
    }
    , {
    ...
    , {
        name: "シトートークン", rarity: "トークン", AW: "未"
        , stats: { atk: "+2000" }
        , note: [ "シトー", "重ね置き(遠近)", "自壊(HP-30/15f)" ]
    }
    , {
        name: "シトートークン", rarity: "トークン", AW: "覚醒"
        , stats: { atk: "+2500" }
        , note: [ "シトー", "重ね置き(遠近)", "自壊(HP-40/15f)" ]
    }
    , {
    ...
    , {
        ...
        , stats: { atk: "+500" }
        , note: [ "オルドネッタ", "重ね置き(遠近)", "自壊(HP-30/15f)" ]
    }
    , {
        name: "オルドネッタトークン", rarity: "トークン", AW: "覚醒"
        , stats: { atk: "+1000" }
        , note: [ "オルドネッタ", "重ね置き(遠近)", "自壊(HP-40/15f)" ]
    }
];
