...
buff.dep_area = [
    ...
    , {
        name: "イムラウ[白]トークン", rarity: "トークン", AW: "覚醒"
        , stats: { other: "" }
        , note: [ "イムラウ[白]", "バリア(3000)付与", "指定範囲" ]
    }
    , {
        name: "イムラウ/お正月[白]トークン", rarity: "トークン", AW: "覚醒"
        , stats: { other: "" }
        , note: [ "イムラウ/お正月[白]", "バリア(2000)付与", "指定範囲" ]
    }
    , {
        name: "イムラウ[黒]トークン", rarity: "トークン", AW: "覚醒"
        , stats: { other: "" }
        , note: [ "イムラウ[黒]", "バリア(10000)付与", "指定範囲" ]
    }
    , {
