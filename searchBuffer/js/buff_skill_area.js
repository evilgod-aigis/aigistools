...
buff.skill_area = [
    ...
    , {
        name: "グレン/学園", rarity: "白", cl: "天狗", AW: "覚醒後", skill: "通常"
        , stats: { atk: "×1.5", def: "×1.2" }
        , target: { season: [ "学園" ] }
    }
    , {
        name: "グレン/学園", rarity: "白", cl: "天狗", AW: "覚醒後", skill: "覚醒"
        , stats: { atk: "×1.3" }
        , target: { season: [ "学園" ] }
    }
    , {
    ...
    , {
        name: "金糸雀姉妹/花嫁", rarity: "白", cl: "かまいたち", AW: "覚醒前", skill: "通常"
        , stats: { atkCd: "6f化" }
        , target: { cl: [ "かまいたち" ] }
    }
    , {
        name: "金糸雀姉妹/花嫁", rarity: "白", cl: "かまいたち", AW: "覚醒後", skill: "通常"
        , stats: { atkCd: "6f化" }
        , target: { cl: [ "かまいたち" ] }
    }
    , {
    ...
    , {
        name: "ハーニィ", rarity: "白", cl: "エンチャンター", AW: "覚醒前", skill: "通常"
        , stats: { atkCd: "6f化", eva: "50%" }
        , target: { depType: [ "近接" ] }
    }
    , {
        name: "ハーニィ", rarity: "白", cl: "エンチャンター", AW: "覚醒後", skill: "通常"
        , stats: { atkCd: "6f化", eva: "50%" }
        , target: { depType: [ "近接" ] }
    }
    , {
