...
target.cl = {
    ...
    , "遠距離": {
        ...
        , normal: [
            ...
            , "夜行さん", "ドラグーン", "ドラゴンメイジ", "座敷わらし", "魔界総帥", "雪娘", "英傑の塔", "リッチ【闇の軍勢】", "政務官【闇の軍勢】"
            , "アイドル召喚士"
            , "支援の聖霊", "ゴブリン博士"
        ]
        , collabo: [
...
target.others = [
    "英傑", "ちび", "弓兵", "魔術師", "アンデッド", "機械", "騎兵", "重装", "聖職者", "魔界", "ドラゴン", "砲兵", "銃士", "飛行"
    , "＜七つの大罪＞"
...
target.count.others = {
    ...
    , "魔術師": [
        ...
        , "シービショップ", "儀式魔術師", "ドラゴンメイジ", "リッチ【闇の軍勢】"
        , "アイドル召喚士"
        , "魔法使い【ランス】"
    ]
    ...
    , "飛行": [
        ...
        , "妖精【七つの大罪】"
        , "ロケットトルーパー", "スカイウォリアー", "スカイシューター", "スカイヒーラー"
        , "不死鳥娘【モンスター娘TD】"
    ]
