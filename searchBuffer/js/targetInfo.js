...
target.cl = {
    "近接": {
        ...
        , normal: [
            ...
            , "シャークウォリアー", "儀仗軍神", "武侠", "サベージファイター", "グレーターデーモン", "皇帝"
        ]
        , collabo: [
            "ねんどろいどプリンセス"
            , "王太子"
...
target.count.home = {
    ...
    , "砂漠の国": [ "ファラオ" ]
    , "東の国": [
        "アヤカシの王", "サムライ", "忍者", "ぬらりひょん", "天狗", "雷公", "風伯", "ぬえ", "鬼刃忍", "犬神", "かまいたち", "ぬりかべ", "霊刀つくもがみ"
        , "シャーマン", "陰陽師", "猫又", "符術士", "狛犬", "霊宝つくもがみ", "夜行さん", "妖狸"
    ]
    , "華の国": [ "仙人", "仙猿", "キョンシー", "真人", "邪仙" ]
    , "パルス王国": [ "王太子" ]
    , "恋姫": [
        "武将【恋姫】", "君主【恋姫】", "奸雄【恋姫】", "勇士【恋姫】", "小覇王【恋姫】"
        , "軍師【恋姫】", "暴君【恋姫】", "弓将【恋姫】"
...
target.count.race = {
    ...
    , "デーモン系": [ "魔神", "デーモンロード", "デモンルーン", "グレーターデーモン" ]
    , "天使": [ "黎明の翼", "エンジェル" ]
    , "妖怪": [
...
target.count.others = {
    ...
    , "魔界": [
        "魔竜騎士", "イビルプリンセス", "中級竜兵", "ドラゴンプリンセス", "魔神", "ダークストーカー", "グラディエーター", "魔王親衛隊", "デーモンロード", "デモンルーン", "グレーターデーモン"
    ...
    , "魔界適応": [
        "魔竜騎士", "黎明の翼", "イビルプリンセス", "中級竜兵", "ドラゴンプリンセス", "魔神", "ダークストーカー", "グラディエーター", "魔王親衛隊", "デーモンロード", "デモンルーン", "グレーターデーモン"
        , "ドラゴンシャーマン", "魔物使い", "ダークプリースト", "デモンサモナー", "デモンシャーマン", "異界召喚士", "魔界総帥"
        , "騎士【七つの大罪】"
    ]
