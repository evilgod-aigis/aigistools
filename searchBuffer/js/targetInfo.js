...
target.cl = {
    "近接": {
        prince: [ "王子" ]
        , hero: [
            "魔竜騎士", "バーバリアンクイーン", "古代魔導機兵", "銀腕の神話", "ウェポンマスター", "魔導生命体", "アヤカシの王"
            , "黎明の翼", "トゥルーブラッド", "暁光の神話", "神獣騎士"
        ]
        , normal: [
            "ソルジャー", "ヘビーアーマー", "ワルキューレ", "ローグ", "プリンセス", "ヴァンパイアプリンセス", "イモータルプリンセス"
            , "イビルプリンセス", "バンデット", "中級竜兵", "ドラゴンプリンセス", "サムライ", "忍者", "ペガサスライダー"
            , "ダークファイター", "アベンジャー", "モンク", "前衛戦術家", "魔法剣士", "エンジェル", "くぐつ使い", "セーラー", "妖狐"
            , "神官戦士", "メイジアーマー", "ドラゴンライダー", "ボウライダー", "メイド", "ヴァンパイアロード", "ソードマスター"
            , "ロイヤルガード", "仙人", "魔神", "仙猿", "戦の聖霊", "ダークストーカー", "ぬらりひょん", "重装砲兵", "鬼"
            , "インペリアルナイト", "天狗", "鍛冶職人", "グラディエーター", "キョンシー", "雷公", "モンスターブレイカー", "風伯"
            , "グランドナイト", "グリフィンライダー", "サッパー", "真人", "邪仙", "魔王親衛隊", "ぬえ", "鬼刃忍", "ランスマスター"
            , "デーモンロード", "犬神", "料理人", "デモンルーン", "スチームナイト", "エンプレス", "かまいたち", "アクアナイト"
            , "シーソルジャー", "テンプルナイト", "迷宮の悪霊", "オートマタ", "ぬりかべ", "霊刀つくもがみ", "戦巫女"
            , "シャークウォリアー", "儀仗軍神", "武侠", "サベージファイター", "ハデスソルジャー", "隧道掘削兵", "シールダー", "女王子"
            , "一目の竜", "天尊"
            , "小悪魔アイドル"
            , "グレーターデーモン", "皇帝"
        ]
        , collabo: [
            ...
            , "王太子"
            , "ホーネット派魔人【ランス】", "忍者【ランス】"
            , "武将【恋姫】", "君主【恋姫】", "奸雄【恋姫】", "勇士【恋姫】", "小覇王【恋姫】"
    ...
    , "遠距離": {
        prince: []
        , hero: [
            "占星術師", "チェイスハンター", "ジオマンサー", "転生魔導士", "ファラオ", "ピューティアー", "カースウィスパラー"
        ]
        , normal: [
            "アーチャー", "メイジ", "ヒーラー", "ウィッチ", "パイレーツ", "ドラゴンシャーマン", "ヴァンパイアハンター", "シャーマン"
            , "ビショップ", "後衛戦術家", "陰陽師", "サモナー", "風水使い", "砲術士", "ダンサー", "政務官", "ネクロマンサー"
            , "クロノウィッチ", "ドルイド", "アルケミスト", "レンジャー", "シーフ", "呪術使い", "魔物使い", "ダークプリースト"
            , "エンチャンター", "マーチャント", "フェンリルシャーマン", "モンスタースレイヤー", "デモンサモナー", "エレメンタラー"
            , "猫又", "道化師", "ライフリンカー", "幻獣使い", "ルーンアコライト", "ロード", "支援工兵", "デモンシャーマン", "異界召喚士"
            , "発明家", "シービショップ", "符術士", "狛犬", "儀式魔術師", "幻術士", "ハーバリスト", "霊宝つくもがみ", "スカラー"
            , "夜行さん", "ドラグーン", "ドラゴンメイジ", "座敷わらし", "魔界総帥", "雪娘"
            , "アイドル召喚士"
        ]
        , collabo: [
    ...
    , "遠近距離": {
        ...
        , normal: [
            "妖狸", "ロケットトルーパー", "スカイウォリアー", "スカイシューター", "スカウト", "スカイヒーラー"
        ]
        , collabo: []
    }
};
target.sex = [ "男性", "女性" ];
target.home = [ "白の帝国", "砂漠の国", "東の国", "華の国", "パルス王国", "恋姫" ];
target.race = [
...
target.others = [
    "英傑", "ちび", "弓兵", "魔術師", "アンデッド", "機械", "騎兵", "重装", "聖職者", "魔界", "ドラゴン", "砲兵", "銃士"
    , "＜七つの大罪＞"
...
target.count.depType = {
    ...
    , "遠距離": {
        prince: []
        , hero: [ "異世界戦士" ]
        , normal: [ "ロケットトルーパー", "スカイシューター", "スカイヒーラー" ]
        , collabo: []
    }
};
target.count.sex = {
...
target.count.home = {
    "白の帝国": [ "インペリアルナイト", "エンプレス", "隧道掘削兵", "皇帝", "支援工兵" ]
    , "砂漠の国": [ "サベージファイター", "ファラオ" ]
    , "東の国": [
...
target.count.race = {
    ...
    , "天使": [ "黎明の翼", "エンジェル" ]
    , "妖怪": [
        "アヤカシの王", "妖狐", "ぬらりひょん", "鬼", "天狗", "雷公", "風伯", "ぬえ", "犬神", "かまいたち", "ぬりかべ", "霊刀つくもがみ"
        , "一目の竜"
        , "猫又", "狛犬", "霊宝つくもがみ", "夜行さん", "座敷わらし", "雪娘"
        , "妖狸"
    ]
    , "仙人": [ "仙人", "仙猿", "真人", "邪仙" ]
    , "オーク": []
    , "ゴブリン": []
    , "鳥人": [ "スカイウォリアー", "スカイシューター", "スカイヒーラー" ]
    , "魚人": [ "シーソルジャー", "シャークウォリアー", "シービショップ" ]
    , "神": [ "銀腕の神話", "暁光の神話", "儀仗軍神", "天尊", "儀式魔術師", "魔界総帥" ]
    , "天界人": [ "ウェポンマスター", "神獣騎士" ]
    , "冥界人": [ "ハデスソルジャー" ]
    , "ねんどろいど": [ "ねんどろいどプリンセス" ]
};
target.count.others = {
    ...
    , "アンデッド": [ "トゥルーブラッド", "ヴァンパイアプリンセス", "イモータルプリンセス", "ヴァンパイアロード", "キョンシー", "ネクロマンサー" ]
    , "機械": [ "古代魔導機兵", "くぐつ使い", "サッパー", "スチームナイト", "アクアナイト", "オートマタ", "隧道掘削兵", "発明家", "ロケットトルーパー" ]
    , "騎兵": [ "魔竜騎士", "神獣騎士", "ワルキューレ", "ペガサスライダー", "ドラゴンライダー", "ボウライダー", "グリフィンライダー", "ドラグーン" ]
    , "重装": [ "ヘビーアーマー", "メイジアーマー", "ロイヤルガード", "重装砲兵", "グランドナイト", "スチームナイト", "アクアナイト", "シールダー" ]
    , "聖職者": [ "神官戦士", "ヒーラー", "ビショップ", "ダークプリースト" , "ルーンアコライト", "シービショップ", "スカイヒーラー" ]
    , "魔界": [
        "魔竜騎士", "イビルプリンセス", "中級竜兵", "ドラゴンプリンセス", "魔神", "ダークストーカー", "グラディエーター", "魔王親衛隊", "デーモンロード", "デモンルーン"
        , "小悪魔アイドル"
        , "グレーターデーモン"
        , "ドラゴンシャーマン", "魔物使い", "ダークプリースト", "デモンサモナー", "デモンシャーマン", "異界召喚士", "魔界総帥"
        /*, "騎士【七つの大罪】"*/
    ]
    , "ドラゴン": [
    ...
    , "砲兵": [ "重装砲兵", "砲術士", "ドラグーン" ]
    , "銃士": [ "異世界戦士", "セーラー", "パイレーツ", "マーチャント", "モンスタースレイヤー", "ロケットトルーパー" ]
