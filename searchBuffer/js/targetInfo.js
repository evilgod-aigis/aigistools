...
target.cl = {
    "近接": {
        ...
        , normal: [
            ...
            , "デモンリドゥ", "カオスルーラー", "衛士", "コロッサス", "妖糸使い", "憤怒の海神"
            , "小悪魔アイドル", "王国民的アイドル"
            , "グレーターデーモン", "ガオレオン", "皇帝"
        ]
        , collabo: [
    ...
    , "遠距離": {
        ...
        , normal: [
            ...
            , "政務官【闇の軍勢】", "ガンスリンガー", "時の俯瞰者", "アイギス神殿", "ハデスシャーマン", "メディック", "豊穣神"
            , "アイドル召喚士"
...
target.count.depType = {
    ...
    , "遠距離": {
        ...
        , hero: [ "異世界戦士" ]
        , normal: [
            "ロケットトルーパー", "スカイシューター", "スカイヒーラー", "エアセイラー"
            , "帝国アイドル"
        ]
...
target.count.sex = {
    "男性": [
        "王子"
        , "魔竜騎士", "暁光の神話", "シャークウォリアー", "一目の竜", "ダーク王子", "憤怒の海神", "グレーターデーモン", "ガオレオン", "皇帝"
        , "王太子", "騎士【七つの大罪】", "盗賊【七つの大罪】", "妖精【七つの大罪】"
        , "ゴブリン博士"
    ]
    , "女性": [
        "バーバリアンクイーン", "古代魔導機兵", "銀腕の神話", "ウェポンマスター", "魔導生命体", "アヤカシの王", "黎明の翼", "トゥルーブラッド", "神獣騎士"
        , "王国軍初代副司令", "大華の神話", "マギステルミリトゥム", "光槍ビルガの継承者", "祖竜", "開天の神話"
...
target.count.home = {
    "王国": [
        "王子", "王国軍初代副司令", "マギステルミリトゥム", "迷宮の悪霊", "女王子", "ダーク王子", "衛士", "王国民的アイドル"
        , "転生魔導士", "政務官", "英傑の塔", "政務官【闇の軍勢】", "アイギス神殿"
    ]
    ,"白の帝国": [ "インペリアルナイト", "エンプレス", "隧道掘削兵", "白の帝国城", "皇帝", "支援工兵", "帝国アイドル" ]
    , "砂漠の国": [ "サベージファイター", "ファラオ" ]
    , "東の国": [
    ...
    , "華の国": [ "大華の神話", "開天の神話", "仙人", "仙猿", "キョンシー", "真人", "邪仙", "武侠" ]
    , "パルス王国": [ "王太子" ]
    , "恋姫": [
        "武将【恋姫】", "君主【恋姫】", "奸雄【恋姫】", "勇士【恋姫】", "小覇王【恋姫】", "王女【恋姫】"
        , "軍師【恋姫】", "暴君【恋姫】", "弓将【恋姫】"
...
target.count.race = {
    ...
    , "人間": [
        "王子"
        , "魔竜騎士", "バーバリアンクイーン", "王国軍初代副司令", "マギステルミリトゥム", "光槍ビルガの継承者"
        , "女王子", "ダーク王子", "皇帝"
        , "王太子"
        ...
        , "怪盗【GBM】", "戯曲作家【GBM】", "物語を渡る者【GBM】", "心ある虫【GBM】", "刑事【GBM】"
        , "対魔忍 超人【対魔忍】", "対魔忍 魔性【対魔忍】", "対魔忍 精神【対魔忍】", "対魔忍 科学【対魔忍】"
        , "占星術師", "ジオマンサー", "転生魔導士", "ファラオ", "ピューティアー", "カースウィスパラー", "未踏海域の覇者"
        , "政務官", "政務官【闇の軍勢】"
        , "アコライト", "魔法使い【ランス】", "初代大統領【ランス】"
        , "軍師【恋姫】", "暴君【恋姫】", "弓将【恋姫】"
        , "水底の支配者【GBM】", "錬金術師【GBM】"
    ...
    , "獣人": [ "ガオレオン" ]
    , "竜人": [ "祖竜", "中級竜兵", "ドラゴンプリンセス", "ドラゴンシャーマン", "ドラゴンメイジ", "黒竜娘【モンスター娘TD】" ]
    ...
    , "仙人": [ "大華の神話", "開天の神話", "仙人", "仙猿", "真人", "邪仙" ]
    , "オーク": []
    , "ゴブリン": [ "ゴブリン博士", "メカゴブリンクイーン" ]
    , "鳥人": [ "スカイウォリアー", "スカイシューター", "スカイヒーラー", "不死鳥娘【モンスター娘TD】" ]
    , "魚人": [ "シーソルジャー", "シャークウォリアー", "シービショップ" ]
    , "神": [
        "銀腕の神話", "暁光の神話", "大華の神話", "開天の神話", "儀仗軍神", "天尊", "カオスルーラー", "コロッサス", "憤怒の海神"
        , "儀式魔術師", "魔界総帥", "時の俯瞰者", "豊穣神"
    ]
    , "天界人": [ "ウェポンマスター", "神獣騎士" ]
    , "冥界人": [ "ハデスソルジャー", "ハデスシャーマン" ]
    , "半神": []
    , "ねんどろいど": [ "ねんどろいどプリンセス" ]
};
target.count.others = {
    ...
    , "ちび": []
    , "弓兵": [ "ボウライダー", "チェイスハンター", "アーチャー", "レンジャー", "スカイシューター", "百腕娘【モンスター娘TD】" ]
    , "魔術師": [
    ...
    , "重装": [
        "マギステルミリトゥム"
        , "ヘビーアーマー", "メイジアーマー", "ロイヤルガード", "重装砲兵", "グランドナイト", "スチームナイト", "アクアナイト", "シールダー", "白の帝国城"
        , "メカゴブリンクイーン"
    ]
    ...
    , "ドラゴン": [
        "竜人", "魔竜騎士", "祖竜", "中級竜兵", "ドラゴンプリンセス", "ドラゴンライダー"
        , "ドラゴンシャーマン", "ドラグーン", "ドラゴンメイジ"
        , "黒竜娘【モンスター娘TD】"
    ]
    , "砲兵": [ "重装砲兵", "白の帝国城", "砲術士", "ドラグーン" ]
    , "銃士": [ "セーラー", "衛士", "パイレーツ", "マーチャント", "モンスタースレイヤー", "ガンスリンガー", "異世界戦士", "ロケットトルーパー" ]
    , "飛行": [
    ...
    */
    ...
    , "深海適応": [ "未踏海域の覇者", "シーソルジャー", "アクアナイト", "シャークウォリアー", "憤怒の海神", "シービショップ" ]
    , "天界適応": [
