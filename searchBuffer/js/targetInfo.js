...
target.cl = {
    ...
    , "遠距離": {
        ...
        , normal: [
            ...
            , "悪疫の王", "蟲使い", "ポーター", "育成の聖霊", "炉の亜神", "永き夢の亜神"
            , "妖精術師【冥府館】"
            , "アイドル召喚士"
...
target.count.sex = {
    ...
    , "女性": [
        ...
        , "王国軍初代副司令", "大華の神話", "マギステルミリトゥム", "光槍ビルガの継承者", "祖竜", "開天の神話", "魔境の主", "侍従の英雄譚"
...
target.count.home = {
    "王国": [
        "王子", "王国軍初代副司令", "マギステルミリトゥム", "侍従の英雄譚", "迷宮の悪霊", "女王子", "ダーク王子", "王城", "統帥の塔", "王国民的アイドル"
...
target.count.race = {
    ...
    , "人間": [
        "王子"
        , "魔竜騎士", "バーバリアンクイーン", "王国軍初代副司令", "マギステルミリトゥム", "光槍ビルガの継承者", "侍従の英雄譚"
        , "女王子", "ダーク王子", "初代皇帝", "皇帝"
        , "王太子"
    ...
    , "神": [
        ...
        , "黒鴉の神話", "儀式魔術師", "魔界総帥", "時の俯瞰者", "豊穣神", "悪疫の王", "炉の亜神", "永き夢の亜神"
    ]
    , "天界人": [ "ウェポンマスター", "神獣騎士" ]
