...
target.count.sex = {
    ...
    , "女性": [
        ...
        , "戦巫女", "女王子", "白の帝国城", "初代皇帝", "王城", "夜の魔女", "統帥の塔", "西の守護虎", "東の守護龍", "サキュバス"
        , "小悪魔アイドル", "王国民的アイドル"
        , "ねんどろいどプリンセス"
        , "ホーネット派魔人【ランス】", "忍者【ランス】"
        , "武将【恋姫】", "君主【恋姫】", "奸雄【恋姫】", "勇士【恋姫】", "小覇王【恋姫】", "王女【恋姫】"
...
target.count.race = {
    ...
    , "神": [
        ...
        , "儀式魔術師", "魔界総帥", "時の俯瞰者", "豊穣神", "悪疫の王", "炉の亜神"
    ]
    , "天界人": [ "ウェポンマスター", "神獣騎士" ]
...
target.count.others = {
    ...
    , "飛行": [
        ...
        , "妖精【七つの大罪】"
        , "ロケットトルーパー", "スカイウォリアー", "スカイシューター", "スカイヒーラー", "エアセイラー", "古代戦艦管理頭脳", "ドラゴンノーブル"
        , "不死鳥娘【モンスター娘TD】"
    ]
    , "深海": [
        "未踏海域の覇者"
