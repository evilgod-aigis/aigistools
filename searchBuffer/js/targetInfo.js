...
target.cl = {
    "近接": {
        ...
        , normal: [
            ...
            , "小悪魔アイドル", "王国民的アイドル"
            , "グレーターデーモン", "ガオレオン", "デーモンシェフ", "チェインソン男", "皇帝"
        ]
        , collabo: [
            "ねんどろいどプリンセス"
            , "王太子"
...
target.count.race = {
    ...
    , "エルフ系": [ "チェイスハンター", "エレメンタルハーミット", "ダークストーカー", "グリフィンライダー", "エンプレス" ]
    , "ドワーフ": []
...
target.count.others = {
    ...
    , "深海": [ "未踏海域の覇者", "セーラー", "シーソルジャー", "アクアナイト", "シャークウォリアー", "憤怒の海神", "パイレーツ", "シービショップ" ]
    , "高貴": [
    ...
    */
    ...
    , "深海適応": [ "未踏海域の覇者", "シーソルジャー", "アクアナイト", "シャークウォリアー", "憤怒の海神"/*, "パイレーツ"*/, "シービショップ" ]
    , "天界適応": [
