...
target.cl = {
    "近接": {
        ...
        , normal: [
            ...
            , "デモンリドゥ", "カオスルーラー", "衛士", "コロッサス", "妖糸使い", "憤怒の海神", "初代皇帝", "王城"
            , "小悪魔アイドル", "王国民的アイドル"
            , "グレーターデーモン", "ガオレオン", "デーモンシェフ", "皇帝"
        ]
        , collabo: [
            "ねんどろいどプリンセス"
            , "王太子"
...
target.count.sex = {
    ...
    , "女性": [
        ...
        , "王国軍初代副司令", "大華の神話", "マギステルミリトゥム", "光槍ビルガの継承者", "祖竜", "開天の神話", "魔境の主"
        , "ワルキューレ", "プリンセス", "ヴァンパイアプリンセス", "イモータルプリンセス", "イビルプリンセス", "ドラゴンプリンセス", "メイド", "エンプレス"
        , "戦巫女", "女王子", "白の帝国城", "初代皇帝", "王城"
        , "小悪魔アイドル", "王国民的アイドル"
        , "ねんどろいどプリンセス"
        , "ホーネット派魔人【ランス】", "忍者【ランス】"
        , "武将【恋姫】", "君主【恋姫】", "奸雄【恋姫】", "勇士【恋姫】", "小覇王【恋姫】", "王女【恋姫】"
...
target.count.home = {
    "王国": [
        "王子", "王国軍初代副司令", "マギステルミリトゥム", "迷宮の悪霊", "女王子", "ダーク王子", "王城", "王国民的アイドル"
        , "転生魔導士", "政務官", "英傑の塔", "政務官【闇の軍勢】", "アイギス神殿"
    ]
    ,"白の帝国": [ "インペリアルナイト", "エンプレス", "白の帝国城", "初代皇帝", "皇帝", "帝国アイドル" ]
    , "砂漠の国": [ "サベージファイター", "ファラオ" ]
    , "東の国": [
...
target.count.race = {
    ...
    , "人間": [
        ...
        , "怪盗【GBM】", "戯曲作家【GBM】", "物語を渡る者【GBM】", "心ある虫【GBM】", "刑事【GBM】"
        , "対魔忍 超人【対魔忍】", "対魔忍 魔性【対魔忍】", "対魔忍 精神【対魔忍】", "対魔忍 科学【対魔忍】"
        , "占星術師", "ジオマンサー", "転生魔導士", "ファラオ", "ピューティアー", "カースウィスパラー", "未踏海域の覇者", "ギアマンサー"
        , "政務官", "政務官【闇の軍勢】"
        , "アコライト", "魔法使い【ランス】", "初代大統領【ランス】"
        , "軍師【恋姫】", "暴君【恋姫】", "弓将【恋姫】"
        , "水底の支配者【GBM】", "錬金術師【GBM】"
...
target.count.others = {
    ...
    , "魔術師": [
        ...
        , "シービショップ", "儀式魔術師", "ドラゴンメイジ", "リッチ【闇の軍勢】", "時の俯瞰者", "呪命師"
        , "アイドル召喚士"
