...
target.cl = {
    "近接": {
        ...
        , hero: [
            ...
            , "トゥルーブラッド", "暁光の神話", "神獣騎士", "王国軍初代副司令", "大華の神話"
        ]
        , normal: [
            ...
            , "ハデスソルジャー", "隧道掘削兵", "シールダー", "女王子", "一目の竜", "天尊", "ダーク王子", "処刑人"
            , "小悪魔アイドル"
            , "グレーターデーモン", "皇帝"
        ]
        , collabo: [
    ...
    , "遠距離": {
        ...
        , normal: [
            ...
            , "英傑の塔", "リッチ【闇の軍勢】", "政務官【闇の軍勢】", "ガンスリンガー"
            , "アイドル召喚士"
            , "支援の聖霊", "ゴブリン博士"
        ]
        , collabo: [
...
target.race = [
    ...
    , "オーク", "ゴブリン", "鳥人", "魚人", "神", "天界人", "冥界人", "ねんどろいど"
];
target.season = [
...
target.others = [
    "英傑", "ちび", "弓兵", "魔術師", "アンデッド", "機械", "騎兵", "重装", "聖職者", "魔界", "ドラゴン", "砲兵", "銃士", "飛行", "深海"
    , "＜七つの大罪＞"
...
target.count.race = {
    ...
    , "神": [ "銀腕の神話", "暁光の神話", "大華の神話", "儀仗軍神", "天尊", "儀式魔術師", "魔界総帥" ]
    , "天界人": [ "ウェポンマスター", "神獣騎士" ]
    , "冥界人": [ "ハデスソルジャー" ]
    , "ねんどろいど": [ "ねんどろいどプリンセス" ]
};
