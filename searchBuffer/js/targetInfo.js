...
target.cl = {
    "近接": {
        ...
        , normal: [
            ...
            , "シャークウォリアー", "儀仗軍神", "武侠", "サベージファイター", "ハデスソルジャー", "隧道掘削兵", "シールダー"
            , "小悪魔アイドル"
            , "グレーターデーモン", "皇帝"
        ]
        , collabo: [
...
target.count.others = {
    ...
    , "騎兵": [ "魔竜騎士", "ワルキューレ", "ペガサスライダー", "ドラゴンライダー", "ボウライダー", "グリフィンライダー", "ドラグーン" ]
    ...
    , "魔界適応": [
        "魔竜騎士", "黎明の翼", "イビルプリンセス", "中級竜兵", "ドラゴンプリンセス", "魔神", "ダークストーカー", "グラディエーター", "魔王親衛隊", "デーモンロード", "デモンルーン"
        , "小悪魔アイドル"
        , "グレーターデーモン"
        , "ドラゴンシャーマン", "魔物使い", "ダークプリースト", "デモンサモナー", "デモンシャーマン", "異界召喚士", "魔界総帥"
        , "騎士【七つの大罪】"
    ...
    , "天界適応": [ "銀腕の神話", "ウェポンマスター", "黎明の翼", "暁光の神話", "エンジェル", "スカイウォリアー", "スカイシューター", "スカイヒーラー" ]
};
