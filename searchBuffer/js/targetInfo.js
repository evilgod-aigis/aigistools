...
target.cl = {
    "近接": {
        ...
        , hero: [
            ...
            , "開天の神話", "魔境の主", "侍従の英雄譚", "キングダムガード", "アイングリアンの騎士"
        ]
        , normal: [
            ...
            , "デモンリドゥ", "カオスルーラー", "衛士", "コロッサス", "妖糸使い", "憤怒の海神", "初代皇帝", "王城", "夜の魔女", "統帥の塔"
            , "混沌霊使い【魔蛸】", "冥府の騎士【円卓】", "西の守護虎", "東の守護龍", "サキュバス", "北の守護亀蛇", "飛電客", "スタンピード", "廻る暗陽"
            , "エリニュス", "導きの少女女神", "復讐の暗黒騎士", "オリュンポス要塞宮殿", "アビサルヘレティック", "シェリフ"
            , "小悪魔アイドル", "王国民的アイドル"
        ...
        , collabo: [
            ...
            , "鬼【ななリン】"
            , "黒竜娘【モンスター娘TD】", "鉄腕娘【モンスター娘TD】", "真鍮竜娘【モンスター娘TD】"
    ...
    , "遠距離": {
        ...
        , hero: [
            ...
            , "悲哀の騎士", "黒鴉の神話", "時間の操者", "フォーチュンルーラー", "輪廻の風水師"
        ]
        , normal: [
            ...
            , "悪疫の王", "蟲使い", "ポーター", "育成の聖霊", "炉の亜神", "永き夢の亜神", "月の神", "芸能の神"
            , "妖精術師【冥府館】"
            , "アイドル召喚士"
...
target.count.depType = {
    ...
    , "遠距離": {
        ...
        , normal: [
            "ロケットトルーパー", "スカイシューター", "スカイヒーラー", "エアセイラー", "古代戦艦管理頭脳", "式神使い"
            , "冬姫【白面金毛】"
            , "帝国アイドル"
        ]
...
target.count.home = {
    "王国": [
        ...
        , "迷宮の悪霊", "女王子", "ダーク王子", "王城", "統帥の塔", "導きの少女女神"
        , "王国民的アイドル"
        , "転生魔導士", "政務官", "英傑の塔", "政務官【闇の軍勢】", "アイギス神殿"
        , "古代戦艦管理頭脳"
    ]
    ,"白の帝国": [
        "インペリアルナイト", "エンプレス", "ハデスソルジャー", "白の帝国城", "初代皇帝", "廻る暗陽", "エリニュス"
        , "冥府の騎士【円卓】", "皇帝"
        , "帝国アイドル"
    ]
    , "砂漠の国": [ "ファラオ", "スフィンクス" ]
...
target.count.race = {
    ...
    , "竜人": [
        "祖竜", "中級竜兵", "ドラゴンプリンセス", "東の守護龍", "ドラゴンシャーマン", "ドラゴンメイジ"
        , "黒竜娘【モンスター娘TD】", "真鍮竜娘【モンスター娘TD】"
    ]
    ...
    , "神": [
        "銀腕の神話", "暁光の神話", "大華の神話", "開天の神話"
        , "儀仗軍神", "天尊", "カオスルーラー", "コロッサス", "憤怒の海神", "夜の魔女", "廻る暗陽", "エリニュス", "導きの少女女神"
        , "スフィンクス"
        , "黒鴉の神話", "儀式魔術師", "魔界総帥", "時の俯瞰者", "豊穣神", "悪疫の王", "炉の亜神", "永き夢の亜神", "月の神", "芸能の神"
    ]
    , "天界人": [ "ウェポンマスター", "神獣騎士" ]
...
target.count.others = {
    ...
    , "魔術師": [
        ...
        , "転生魔導士", "カースウィスパラー", "黒鴉の神話", "時間の操者", "フォーチュンルーラー"
    ...
    , "重装": [
        "マギステルミリトゥム", "キングダムガード"
        , "ヘビーアーマー", "メイジアーマー", "ロイヤルガード", "重装砲兵", "グランドナイト", "スチームナイト", "アクアナイト", "シールダー", "復讐の暗黒騎士"
        , "白の帝国城", "王城"
        , "メカゴブリンクイーン"
    ]
    , "聖職者": [
    ...
    , "銃士": [
        "セーラー", "衛士", "シェリフ"
        , "パイレーツ", "マーチャント", "モンスタースレイヤー", "ガンスリンガー", "ポーター", "異世界戦士", "ロケットトルーパー"
    ]
    , "飛行": [
        "開天の神話", "アイングリアンの騎士"
    ...
    , "深海": [
        "未踏海域の覇者"
        , "セーラー", "シーソルジャー", "アクアナイト", "シャークウォリアー", "憤怒の海神", "混沌霊使い【魔蛸】", "アビサルヘレティック"
        , "触手少女【ルルイエ】"
    ...
    */
    ...
    , "魔界適応": [
        "魔竜騎士", "黎明の翼", "神獣騎士", "祖竜"
        , "イビルプリンセス", "中級竜兵", "ドラゴンプリンセス", "魔神", "ダークストーカー", "グラディエーター", "魔王親衛隊", "デーモンロード", "デモンルーン"
        , "ダーク王子", "デモンリドゥ", "カオスルーラー", "導きの少女女神", "復讐の暗黒騎士"
        , "小悪魔アイドル"
        , "グレーターデーモン", "ガオレオン", "デーモンシェフ", "グラシャラボラス"
        , "ドラゴンシャーマン", "魔物使い", "ダークプリースト", "デモンサモナー", "デモンシャーマン", "異界召喚士", "魔界総帥", "政務官【闇の軍勢】"
        , "ゴブリン博士", "メカゴブリンクイーン"
    ...
    , "天界適応": [
        "銀腕の神話", "ウェポンマスター", "黎明の翼", "暁光の神話", "神獣騎士"
        , "エンジェル", "導きの少女女神"
        , "スカイウォリアー", "スカイシューター", "スカイヒーラー"
    ]
};
